...
wxLuaBindEvent* wxLuaGetEventList_wxbase(size_t &count)
{
    static wxLuaBindEvent eventList[] =
    {
        ...
        { "wxEVT_FSWATCHER", WXLUA_GET_wxEventType_ptr(wxEVT_FSWATCHER), &wxluatype_wxFileSystemWatcherEvent },
...
wxLuaBindNumber* wxLuaGetDefineList_wxbase(size_t &count)
{
    static wxLuaBindNumber numberList[] =
    {
        ...
        { "wxFSWPath_File", wxFSWPath_File },
        { "wxFSWPath_None", wxFSWPath_None },
        { "wxFSWPath_Tree", wxFSWPath_Tree },
        { "wxFSW_EVENT_ACCESS", wxFSW_EVENT_ACCESS },
        { "wxFSW_EVENT_ALL", wxFSW_EVENT_ALL },
        { "wxFSW_EVENT_ATTRIB", wxFSW_EVENT_ATTRIB },
        { "wxFSW_EVENT_CREATE", wxFSW_EVENT_CREATE },
        { "wxFSW_EVENT_DELETE", wxFSW_EVENT_DELETE },
        { "wxFSW_EVENT_ERROR", wxFSW_EVENT_ERROR },
        { "wxFSW_EVENT_MODIFY", wxFSW_EVENT_MODIFY },
...
// wxLuaGetStringList_wxbase() is called to register #define_string
// ---------------------------------------------------------------------------
...
static int LUACALL wxLua_function_wxGetTranslation(lua_State *L)
{
    ...
    const wxString sz = wxlua_getwxStringtype(L, 1);
    // call wxGetTranslation
    wxString returns = (wxGetTranslation(sz, domain));
    // push the result string
    wxlua_pushwxString(L, returns);
...
static int LUACALL wxLua_function_wxGetTranslationPlural(lua_State *L)
{
    ...
    const wxString sz1 = wxlua_getwxStringtype(L, 1);
    // call wxGetTranslation
    wxString returns = (wxGetTranslation(sz1, sz2, n, domain));
    // push the result string
    wxlua_pushwxString(L, returns);
...
static const char* wxluaclassname_wxEventFilter = "wxEventFilter";
static const char* wxluaclassname_wxEventLoopBase = "wxEventLoopBase";
...
static const char* wxluaclassname_wxFileSystemWatcher = "wxFileSystemWatcher";
static const char* wxluaclassname_wxFileSystemWatcherEvent = "wxFileSystemWatcherEvent";
static const char* wxluaclassname_wxFileTranslationsLoader = "wxFileTranslationsLoader";
...
static const char* wxluaclassname_wxMemoryOutputStream = "wxMemoryOutputStream";
static const char* wxluaclassname_wxMimeTypesManager = "wxMimeTypesManager";
static const char* wxluaclassname_wxMsgCatalog = "wxMsgCatalog";
...
static const char* wxluaclassname_wxResourceTranslationsLoader = "wxResourceTranslationsLoader";
...
static const char* wxluaclassname_wxStringInputStream = "wxStringInputStream";
static const char* wxluaclassname_wxStringOutputStream = "wxStringOutputStream";
static const char* wxluaclassname_wxStringTokenizer = "wxStringTokenizer";
static const char* wxluaclassname_wxString_const_iterator = "wxString_const_iterator";
...
static const char* wxluaclassname_wxVariantList = "wxVariantList";
...
static const char* wxluabaseclassnames_wxFileSystemWatcher[] = { wxluaclassname_wxEvtHandler, NULL };
static wxLuaBindClass* wxluabaseclassbinds_wxFileSystemWatcher[] = { NULL };
static const char* wxluabaseclassnames_wxFileSystemWatcherEvent[] = { wxluaclassname_wxEvent, NULL };
static wxLuaBindClass* wxluabaseclassbinds_wxFileSystemWatcherEvent[] = { NULL };
static const char* wxluabaseclassnames_wxFileTranslationsLoader[] = { wxluaclassname_wxTranslationsLoader, NULL };
static wxLuaBindClass* wxluabaseclassbinds_wxFileTranslationsLoader[] = { NULL };
...
static const char* wxluabaseclassnames_wxMemoryOutputStream[] = { wxluaclassname_wxOutputStream, NULL };
static wxLuaBindClass* wxluabaseclassbinds_wxMemoryOutputStream[] = { NULL };
...
static const char* wxluabaseclassnames_wxResourceTranslationsLoader[] = { wxluaclassname_wxTranslationsLoader, NULL };
static wxLuaBindClass* wxluabaseclassbinds_wxResourceTranslationsLoader[] = { NULL };
...
static const char* wxluabaseclassnames_wxStringInputStream[] = { wxluaclassname_wxInputStream, NULL };
static wxLuaBindClass* wxluabaseclassbinds_wxStringInputStream[] = { NULL };
static const char* wxluabaseclassnames_wxStringOutputStream[] = { wxluaclassname_wxOutputStream, NULL };
static wxLuaBindClass* wxluabaseclassbinds_wxStringOutputStream[] = { NULL };
...
static const char* wxluabaseclassnames_wxVariantList[] = { wxluaclassname_wxList, NULL };
static wxLuaBindClass* wxluabaseclassbinds_wxVariantList[] = { NULL };
// ---------------------------------------------------------------------------
// Lua Tag Method Values and Tables for each Class
// ---------------------------------------------------------------------------

#if (defined (__WINDOWS__ )) && (wxCHECK_VERSION(2,9,1) && wxLUA_USE_wxTranslations) && (wxUSE_INTL)
...
#endif // (defined (__WINDOWS__ )) && (wxCHECK_VERSION(2,9,1) && wxLUA_USE_wxTranslations) && (wxUSE_INTL)

#if (wxCHECK_VERSION(2,9,1) && wxLUA_USE_wxTranslations) && (wxUSE_INTL)
    ...
    extern wxLuaBindMethod wxMsgCatalog_methods[];
    extern int wxMsgCatalog_methodCount;
    extern void wxLua_wxMsgCatalog_delete_function(void** p);
    extern wxLuaBindMethod wxTranslations_methods[];
    extern int wxTranslations_methodCount;
    extern void wxLua_wxTranslations_delete_function(void** p);
...
#endif // (wxCHECK_VERSION(2,9,1) && wxLUA_USE_wxTranslations) && (wxUSE_INTL)
...
extern wxLuaBindMethod wxEventFilter_methods[];
extern int wxEventFilter_methodCount;
extern void wxLua_wxEventFilter_delete_function(void** p);
extern wxLuaBindMethod wxEventLoopBase_methods[];
extern int wxEventLoopBase_methodCount;
extern void wxLua_wxEventLoopBase_delete_function(void** p);
...
extern void wxLua_wxStringTokenizer_delete_function(void** p);
...
#if wxCHECK_VERSION(2,9,0)
    extern wxLuaBindMethod wxString_const_iterator_methods[];
    extern int wxString_const_iterator_methodCount;
    extern void wxLua_wxString_const_iterator_delete_function(void** p);
    extern wxLuaBindMethod wxString_iterator_methods[];
...
#if wxUSE_FSWATCHER && wxCHECK_VERSION(2,9,4)
    extern wxLuaBindMethod wxFileSystemWatcher_methods[];
    extern int wxFileSystemWatcher_methodCount;
    extern void wxLua_wxFileSystemWatcher_delete_function(void** p);
    extern wxLuaBindMethod wxFileSystemWatcherEvent_methods[];
    extern int wxFileSystemWatcherEvent_methodCount;
    ...
    extern wxLuaBindMethod wxMemoryOutputStream_methods[];
    extern int wxMemoryOutputStream_methodCount;
    extern void wxLua_wxMemoryOutputStream_delete_function(void** p);
    ...
    extern wxLuaBindMethod wxStringInputStream_methods[];
    extern int wxStringInputStream_methodCount;
    extern void wxLua_wxStringInputStream_delete_function(void** p);
    extern wxLuaBindMethod wxStringOutputStream_methods[];
    extern int wxStringOutputStream_methodCount;
    extern void wxLua_wxStringOutputStream_delete_function(void** p);
    ...
    extern wxLuaBindMethod wxVariantList_methods[];
    extern int wxVariantList_methodCount;
    extern void wxLua_wxVariantList_delete_function(void** p);
#endif // wxUSE_VARIANT
...
wxLuaBindClass* wxLuaGetClassList_wxbase(size_t &count)
{
    static wxLuaBindClass classList[] =
    {
        ...
        { wxluaclassname_wxEventFilter, wxEventFilter_methods, wxEventFilter_methodCount, NULL, &wxluatype_wxEventFilter, NULL, NULL, NULL, NULL, NULL, 0, &wxLua_wxEventFilter_delete_function, }, 
        { wxluaclassname_wxEventLoopBase, wxEventLoopBase_methods, wxEventLoopBase_methodCount, NULL, &wxluatype_wxEventLoopBase, NULL, NULL, NULL, NULL, NULL, 0, &wxLua_wxEventLoopBase_delete_function, }, 
        ...
        { wxluaclassname_wxMemoryOutputStream, wxMemoryOutputStream_methods, wxMemoryOutputStream_methodCount, NULL, &wxluatype_wxMemoryOutputStream, wxluabaseclassnames_wxMemoryOutputStream, wxluabaseclassbinds_wxMemoryOutputStream, NULL, NULL, NULL, 0, &wxLua_wxMemoryOutputStream_delete_function, }, 
#endif // wxUSE_STREAMS
...
#if wxUSE_STREAMS
        { wxluaclassname_wxStringInputStream, wxStringInputStream_methods, wxStringInputStream_methodCount, NULL, &wxluatype_wxStringInputStream, wxluabaseclassnames_wxStringInputStream, wxluabaseclassbinds_wxStringInputStream, NULL, NULL, NULL, 0, &wxLua_wxStringInputStream_delete_function, }, 
        { wxluaclassname_wxStringOutputStream, wxStringOutputStream_methods, wxStringOutputStream_methodCount, NULL, &wxluatype_wxStringOutputStream, wxluabaseclassnames_wxStringOutputStream, wxluabaseclassbinds_wxStringOutputStream, NULL, NULL, NULL, 0, &wxLua_wxStringOutputStream_delete_function, }, 
#endif // wxUSE_STREAMS
...
#if wxCHECK_VERSION(2,9,0)
        { wxluaclassname_wxString_const_iterator, wxString_const_iterator_methods, wxString_const_iterator_methodCount, NULL, &wxluatype_wxString_const_iterator, NULL, NULL, NULL, NULL, NULL, 0, &wxLua_wxString_const_iterator_delete_function, }, 
        { wxluaclassname_wxString_iterator, wxString_iterator_methods, wxString_iterator_methodCount, NULL, &wxluatype_wxString_iterator, NULL, NULL, NULL, NULL, NULL, 0, &wxLua_wxString_iterator_delete_function, }, 
#endif // wxCHECK_VERSION(2,9,0)
        ...
        { wxluaclassname_wxVariantList, wxVariantList_methods, wxVariantList_methodCount, NULL, &wxluatype_wxVariantList, wxluabaseclassnames_wxVariantList, wxluabaseclassbinds_wxVariantList, NULL, NULL, NULL, 0, &wxLua_wxVariantList_delete_function, }, 
#endif // wxUSE_VARIANT
