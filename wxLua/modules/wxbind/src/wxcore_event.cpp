...
#if ((wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxPointSizeRect))||((!wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxPointSizeRect))
// function overload table
...
#endif // ((wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxPointSizeRect))||((!wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxPointSizeRect))
...
static int LUACALL wxLua_wxThreadEvent_constructor(lua_State *L)
{
    ...
    // wxEventType eventType = wxEVT_THREAD_CAST
    wxEventType eventType = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : wxEVT_THREAD_CAST);
    // call constructor
