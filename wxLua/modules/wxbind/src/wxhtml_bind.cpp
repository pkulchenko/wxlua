...
#if ((wxCHECK_VERSION(2,9,0)) && (wxLUA_USE_wxHTML && wxUSE_HTML)) && (wxLUA_USE_wxArrayInt)
...
#endif // ((wxCHECK_VERSION(2,9,0)) && (wxLUA_USE_wxHTML && wxUSE_HTML)) && (wxLUA_USE_wxArrayInt)

#if (wxLUA_USE_wxArrayInt) && ((wxCHECK_VERSION(2,8,0) && !wxCHECK_VERSION(2,9,0)) && (wxLUA_USE_wxHTML && wxUSE_HTML))
...
#endif // (wxLUA_USE_wxArrayInt) && ((wxCHECK_VERSION(2,8,0) && !wxCHECK_VERSION(2,9,0)) && (wxLUA_USE_wxHTML && wxUSE_HTML))
...
#elif (wxLUA_USE_wxArrayInt) && ((wxCHECK_VERSION(2,8,0) && !wxCHECK_VERSION(2,9,0)) && (wxLUA_USE_wxHTML && wxUSE_HTML))
    { "AdjustPagebreak", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxHtmlCell_AdjustPagebreak, 1, NULL },
