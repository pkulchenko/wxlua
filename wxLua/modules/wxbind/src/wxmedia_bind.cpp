...
#if ((wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_wxValidator && wxUSE_VALIDATORS)
...
#endif // ((wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_wxValidator && wxUSE_VALIDATORS)
...
#endif // (((wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_wxValidator && wxUSE_VALIDATORS))||(wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL)
...
wxLuaBindString* wxLuaGetStringList_wxmedia(size_t &count)
{
    ...
    {
#if wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL
        wxLuaBindString( "wxMEDIABACKEND_DIRECTSHOW", wxMEDIABACKEND_DIRECTSHOW),
        wxLuaBindString( "wxMEDIABACKEND_GSTREAMER", wxMEDIABACKEND_GSTREAMER),
        wxLuaBindString( "wxMEDIABACKEND_MCI", wxMEDIABACKEND_MCI),
        wxLuaBindString( "wxMEDIABACKEND_QUICKTIME", wxMEDIABACKEND_QUICKTIME),
#endif // wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL

#if (wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL)
        wxLuaBindString( "wxMEDIABACKEND_REALPLAYER", wxMEDIABACKEND_REALPLAYER),
        wxLuaBindString( "wxMEDIABACKEND_WMP10", wxMEDIABACKEND_WMP10),
