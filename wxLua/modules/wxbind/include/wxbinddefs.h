...
#endif
#ifndef wxLUA_USEBINDING_WXPROPGRID
    #define wxLUA_USEBINDING_WXPROPGRID                 1
#endif
...
#if wxLUA_USEBINDING_WXPROPGRID
    #define WXLUA_DECLARE_BIND_WXPROPGRID  extern WXDLLIMPEXP_BINDWXPROPGRID  wxLuaBinding* wxLuaBinding_wxpropgrid_init(); // modules/wxbind
    #define WXLUA_IMPLEMENT_BIND_WXPROPGRID  wxLuaBinding_wxpropgrid_init();
#else
    #define WXLUA_DECLARE_BIND_WXPROPGRID
    #define WXLUA_IMPLEMENT_BIND_WXPROPGRID
#endif // wxLUA_USEBINDING_WXPROPGRID
...
#define WXLUA_IMPLEMENT_BIND_ALL \
    ...
    WXLUA_IMPLEMENT_BIND_WXPROPGRID \
