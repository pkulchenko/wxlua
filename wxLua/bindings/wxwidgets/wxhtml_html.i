...
%class %delete wxHtmlCell, wxObject
    ...
    %not_overload %wxchkver_2_8 & !%wxchkver_2_9_3 virtual bool AdjustPagebreak(int pagebreak, wxArrayInt& known_pagebreaks)
    ...
    %not_overload %wxchkver_2_9_3 virtual bool AdjustPagebreak(int pagebreak, wxArrayInt& known_pagebreaks, int pageHeight)
...
%class wxSimpleHtmlListBox, wxPanel, wxHtmlWindowInterface //: public wxHtmlListBox, public wxItemContainer
    wxSimpleHtmlListBox()
...
%class %delete wxHtmlDCRenderer, wxObject
    wxHtmlDCRenderer()
...
%class %delete wxHtmlEasyPrinting, wxObject
...
%class %delete wxHtmlPrintout, wxPrintout
