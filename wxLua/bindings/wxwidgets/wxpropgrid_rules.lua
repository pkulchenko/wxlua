-- ----------------------------------------------------------------------------
-- Rules to build wxWidgets' wxRichText binding for wxLua
...
output_cpp_impexpsymbol     = "WXDLLIMPEXP_BINDWXPROPGRID"
output_cpp_impexpdatasymbol = "WXDLLIMPEXP_DATA_BINDWXPROPGRID"
...
-- ----------------------------------------------------------------------------
-- Add additional preprocessor defs to use while parsing the interface files.
-- example: interfaceCppDefines["WXDLLIMPEXP_PROPGRID"] = ""

skipBindingKeywordTable["WXDLLIMPEXP_PROPGRID"] = ""
