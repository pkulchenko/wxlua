-- ----------------------------------------------------------------------------
-- Rules to build wxWidgets' wxMedia binding for wxLua
...
output_cpp_impexpsymbol     = "WXDLLIMPEXP_BINDWXMEDIA"
output_cpp_impexpdatasymbol = "WXDLLIMPEXP_DATA_BINDWXMEDIA"
...
--   table {} for none.
--   The files are loaded from the interface_filepath.
--override_fileTable = { "wxmedia_override.hpp" }
