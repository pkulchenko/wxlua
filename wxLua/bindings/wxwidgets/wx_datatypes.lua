...
wx_dataTypeTable =
{
  ...
  wxFileTranslationsLoader = {
    ...
    Condition = "(wxCHECK_VERSION(2,9,1)) && (wxUSE_INTL && wxLUA_USE_wxTranslations)",
    IsNumber = false,
  ...
  wxFontEncoding = {
    Condition = "wxUSE_INTL && wxLUA_USE_wxTranslations",
    IsNumber = true,
    Name = "wxFontEncoding",
    ValueType = "enum",
  },
  ...
  wxLayoutDirection = {
    Condition = "(wxCHECK_VERSION(2,8,0)) && (wxUSE_INTL && wxLUA_USE_wxTranslations)",
    IsNumber = true,
  ...
  wxResourceTranslationsLoader = {
    ...
    Condition = "(defined (__WINDOWS__ )) && (wxCHECK_VERSION(2,9,1)) && (wxUSE_INTL && wxLUA_USE_wxTranslations)",
    IsNumber = false,
...
wx_preprocConditionTable =
{
  ...
  ["%wxchkver_3_0_1"] = "wxCHECK_VERSION(3,0,1)",
  ...
  ["%wxcompat_3_0"] = "(defined(WXWIN_COMPATIBILITY_3_0) && WXWIN_COMPATIBILITY_3_0)",
  ...
  wxUSE_PRIVATE_FONTS = "wxUSE_PRIVATE_FONTS",
