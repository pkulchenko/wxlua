...
output_cpp_impexpsymbol     = "WXDLLIMPEXP_BINDWXSTC"
output_cpp_impexpdatasymbol = "WXDLLIMPEXP_DATA_BINDWXSTC"
...
--   table {} for none.
--   The files are loaded from the interface_filepath.
override_fileTable = { "wxstc_override.hpp" }
