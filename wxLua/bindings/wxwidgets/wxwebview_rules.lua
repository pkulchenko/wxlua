-- ----------------------------------------------------------------------------
-- Rules to build wxWidgets' wxWebView binding for wxLua
...
output_cpp_impexpsymbol     = "WXDLLIMPEXP_BINDWXWEBVIEW"
output_cpp_impexpdatasymbol = "WXDLLIMPEXP_DATA_BINDWXWEBVIEW"
