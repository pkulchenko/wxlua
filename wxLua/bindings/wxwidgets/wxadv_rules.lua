-- ----------------------------------------------------------------------------
-- Rules to build wxWidgets' wxAdv binding for wxLua
...
output_cpp_impexpsymbol     = "WXDLLIMPEXP_BINDWXADV"
output_cpp_impexpdatasymbol = "WXDLLIMPEXP_DATA_BINDWXADV"
...
--   table {} for none.
--   The files are loaded from the interface_filepath.
override_fileTable = { "wxadv_override.hpp" }
