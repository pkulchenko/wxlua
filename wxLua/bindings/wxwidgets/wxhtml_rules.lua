-- ----------------------------------------------------------------------------
-- Rules to build wxWidgets' wxHTML binding for wxLua
...
output_cpp_impexpsymbol     = "WXDLLIMPEXP_BINDWXHTML"
output_cpp_impexpdatasymbol = "WXDLLIMPEXP_DATA_BINDWXHTML"
...
--   table {} for none.
--   The files are loaded from the interface_filepath.
override_fileTable = { "wxhtml_override.hpp" }
