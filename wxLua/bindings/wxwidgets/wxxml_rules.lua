-- ----------------------------------------------------------------------------
-- Rules to build wxWidgets' wxXML binding for wxLua
...
output_cpp_impexpsymbol     = "WXDLLIMPEXP_BINDWXXML"
output_cpp_impexpdatasymbol = "WXDLLIMPEXP_DATA_BINDWXXML"
...
--   table {} for none.
--   The files are loaded from the interface_filepath.
override_fileTable = { "wxxml_override.hpp" }
