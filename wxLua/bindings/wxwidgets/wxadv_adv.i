...
%class wxBitmapComboBox, wxControl
    wxBitmapComboBox()
...
%class %delete wxLayoutAlgorithm, wxObject
    wxLayoutAlgorithm()
...
%class %delete wxTaskBarIconEvent, wxEvent
