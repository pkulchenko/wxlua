-- ----------------------------------------------------------------------------
-- Rules to build wxWidgets' wxNet binding for wxLua
...
output_cpp_impexpsymbol     = "WXDLLIMPEXP_BINDWXNET"
output_cpp_impexpdatasymbol = "WXDLLIMPEXP_DATA_BINDWXNET"
...
--   table {} for none.
--   The files are loaded from the interface_filepath.
override_fileTable = { "wxnet_override.hpp" }
