...
output_cpp_header_filepath = wxlua_dir.."modules/wxlua/debugger"
output_cpp_filepath        = wxlua_dir.."modules/wxlua/debugger"
...
hook_cpp_header_filename = "wxlua/debugger/"..hook_cpp_namespace.."_bind.h"
