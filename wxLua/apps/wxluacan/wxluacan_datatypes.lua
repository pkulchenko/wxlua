-- ---------------------------------------------------------------------------
-- ./wxluacan_datatypes.lua was generated by genwxbind.lua 
-- 
...
wxluacan_dataTypeTable =
{
  ...
  wxlCanObjScript = {
    ...
    IsNumber = false,
    Name = "wxlCanObjScript",
    ValueType = "class",
  },
  wxlLuaCanCmd = {
    BaseClasses = {
      [1] = "wxCommandProcessor",
    },
    IsNumber = false,
    Name = "wxlLuaCanCmd",
    ValueType = "class",
...
-- ---------------------------------------------------------------------------
wxluacan_preprocConditionTable =
{
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxluacan_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxluacan_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxluacan_preprocConditionTable) do
